...
export class BVHFlatNode {
  idSelf = 0;
  idObject = -1; // negative id means that this is another inner node
  idRightChild = 0;
  idParent = 0;
...
function BVH_Create_Node(workList: Uint32Array, aabb_array: Float32Array, idParent: number, isLeftBranch: boolean)
{
...
export function BVH_Build_Iterative(workList: Uint32Array, aabb_array: Float32Array) {
  ...
  let buildnodesLength = buildnodes.length;
